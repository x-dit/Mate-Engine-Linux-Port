Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/fb9a15d9cbb4bff42aa4321b127a66ce"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				emissionColor0 = emissionTex.rgb * lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.2212531,0.3971062,0.4264151,1).rgb, 0.0);
				emissionAlpha = emissionTex.a;
				#else
				emissionColor0 = lerp(1, poiFragData.baseColor, mixBaseColor).rgb * poiThemeColor(poiMods, float4(0.2212531,0.3971062,0.4264151,1).rgb, 0.0);
				#endif
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.3690279,0.5956195,0.6231937,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.3690279,0.5956195,0.6231937,1).a;
				#else
